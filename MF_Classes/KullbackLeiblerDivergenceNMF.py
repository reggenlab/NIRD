...
class KullbackLeiblerDivergenceNMF(NonNegativeMatrixFactorization_NIMFA):

	def __init__(self, data) -> None:
		super().__init__(data)

	def _get_factorizer(self):
		_nmf = nimfa.Nmf(V=self.scaled_exp, seed="random", rank=self.n_components, update='divergence')
		_fit = _nmf()
		return _nmf, _fit
